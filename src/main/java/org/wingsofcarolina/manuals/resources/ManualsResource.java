...
public class ManualsResource {
	...
	private String contactMessage(String name, String email, String message) {
		...
		msg.append("*Manuals contact sent at : ").append(dateFormatGmt.format(now)).append("*\n");
		msg.append("**Contact from:** ").append(name).append(" (").append(email).append(")\n");
	...
	private String uploadMessage(User user, ManualType type, String identifier) {
		...
		StringBuilder msg = new StringBuilder();
		msg.append("*WCFC Manuals Server notification sent at : ").append(dateFormatGmt.format(now)).append("*\n");
	...
	private String archiveMessage(User user, String filename, String size) {
		...
		msg.append("A new WCFC Manuals ZIP archive has been generated by ").append(user.getName());
		msg.append(". The archive name is '").append(filename).append("' and it is ").append(size).append(" in size.");
