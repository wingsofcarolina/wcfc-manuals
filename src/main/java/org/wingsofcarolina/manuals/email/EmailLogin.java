...
public class EmailLogin {
	...
	static final String HTMLBODY = "<html><div class=body>"
			...
			+ "<p>This email contains a URL you can use to log into the WCFC Manuals server. "
			...
			+ "<div class=link><a href=SERVER/api/member/verify/UUID/CODE>Log into the WCFC Manuals server for EMAIL</a></div>"
			+ "<p>If that link fails, paste the following URL into your browser instead :</p>"
			+ "<div class=link>SERVER/api/member/verify/UUID/CODE</div>"
	...
	static final String TEXTBODY = "WCFC Manuals Login\n"
			+ "This email contains a URL you can use to log into the WCFC Manuals server.\n"
